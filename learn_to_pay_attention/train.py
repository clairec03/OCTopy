...
parser.add_argument(
    "--attn_mode", type=str, default="after", help="insert attention modules before OR after maxpooling layers"
)
...
def main():
    ...
    trainloader = torch.utils.data.DataLoader(
        trainset, batch_size=opt.batch_size, shuffle=True, num_workers=8, worker_init_fn=_worker_init_fn_
    )
