...
parser.add_argument(
    "-data", metavar="DIR", default="/mnt/c/Users/Sean/Downloads/OCT_DATASET_DO_NOT_SHARE_WITH_ANYONE_split/UNL/", help="path to dataset"
)
parser.add_argument("-dataset-name", default="oct", help="dataset name", choices=["oct", "stl10", "cifar10"])
parser.add_argument(
    "-a",
    "--arch",
    metavar="ARCH",
